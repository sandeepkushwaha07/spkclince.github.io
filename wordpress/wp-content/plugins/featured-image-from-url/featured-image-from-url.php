...
function fifu_row_meta($plugin_meta, $plugin_file, $plugin_data, $status) {
    if (strpos($plugin_file, 'featured-image-from-url.php') !== false) {
        ...
        $tag_review = '<a title="' . $strings['star']() . '" href="https://wordpress.org/support/plugin/featured-image-from-url/reviews/?filter=5" target="_blank"><span class="dashicons dashicons-star-filled"></span></a>';
        $tag_pro = '<a href="https://fifu.app/" target="_blank"><span style="padding:5px;color:white;background-color:#d63638">' . $strings['upgrade']() . '</span></a>';
        $email = '<a style="width:184px;padding:5px;color:white;background-color:#02a0d2"><b>' . $strings['support']() . '</b>: marcel@fifu.app</a>';
