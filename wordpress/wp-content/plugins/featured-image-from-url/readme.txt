...
= 4.4.5 =
* Enhancement: image search on quick/post editor (integration with search engine).

= 4.4.4 =
* New option: Auto set featured image using post title and search engine → License filter; new option: Cloud → Hotlink protection (can be disabled now).

= 4.4.3 =
* Fix: FIFU Cloud (increased timeout); note: thanks to the community for releasing the translation of the README in 10 different languages. The translation in 100 other languages is ready and still awaiting approval.
